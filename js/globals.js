...
const noticesManagerModal=document.getElementById('noticesManagerModal'), noticesManagerClose=document.getElementById('noticesManagerClose'), btnOpenNoticesManager=document.getElementById('btnOpenNoticesManager');
